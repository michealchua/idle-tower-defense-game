...
export const biomeDefinitions: Record<BiomeId, BiomeDefinition> = {
  ...
  snowMountain: {
    ...
    musicTrack: 'audio/snow-mountain.ogg',
  ...
  poisonSwamp: {
    ...
    musicTrack: 'audio/poison-swamp.ogg',
  ...
  darkCave: {
    ...
    musicTrack: 'audio/dark-cave.ogg',
  ...
  ancientRuins: {
    ...
    musicTrack: 'audio/ancient-ruins.ogg',
  ...
  skyRealm: {
    ...
    musicTrack: 'audio/sky-realm.ogg',
  ...
  demonAbyss: {
    ...
    musicTrack: 'audio/demon-abyss.ogg',
