            ...
            return (
              ...
              >
                ...
                <div className="item-detail">
                  {t('petRoster.passiveBonus')}: {bonusLabel} · {t('hero.attackDamage')} {Math.round(pet.attackDamage)}
                </div>
                <div className="item-actions" style={{ alignItems: 'center' }}>
                  ...
                  <button className="btn btn-sm" onClick={() => starUpPet(definition.id)} disabled={!nextCost || !canStarUp}>
                    {nextCost
                ...
                <div className="item-actions">
                  {isDeployed ? (
                    <button className="btn btn-sm" onClick={() => undeployPet(definition.id)}>
                      {t('squad.deployed')} → {t('squad.undeploy')}
                    </button>
                  ) : (
                    <button className="btn btn-sm" disabled={squadFull} onClick={() => deployPet(definition.id)}>
